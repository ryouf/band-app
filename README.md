# محلل العقود القانونية بالذكاء الاصطناعي
...
- `app/api/analyse/route.js` — تحليل العقد بالذكاء الاصطناعي
- `app/api/parse-pdf/route.js` — استخراج النص من PDF
- `app/page.js` — الواجهة الرئيسية
- `.env.local` — متغيرات البيئة (غير مرفوعة)

## تنبيه
هذه الأداة للاسترشاد فقط وليست استشارة قانونية معتمدة.

## المطور
Ruyouf Alghamdi — مشروع LaunchLab SA